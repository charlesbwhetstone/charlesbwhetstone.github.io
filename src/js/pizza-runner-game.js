class PizzaRunnerGame {
    ...
    drawGameOverScreen() {
        ...
        this.ctx.font = '24px Arial';
        this.ctx.fillText('Press spacebar, click, or tap to restart', this.canvas.width / 2, this.canvas.height / 2 + 60);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        const gameCanvas = document.getElementById('pizza-runner-canvas');
        if (gameCanvas) {
            new PizzaRunnerGame('pizza-runner-canvas');
        }
    }, 500);
});