...
<div class="game-container">
  ...
  <div class="game-wrapper">
    ...
    <!-- Debug Toggle for Desktop Testing -->
    <div id="debugToggle" style="position:fixed; top:10px; right:10px; z-index:1001; background:rgba(0,0,0,0.7); color:white; padding:5px 10px; border-radius:5px; cursor:pointer; font-size:12px;" onclick="toggleMobileControls()">Toggle Touch Controls</div>
